          ...
          <div className="container py-20">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-12 flex flex-wrap items-center justify-center gap-6">
                ...
                <Link href="https://twitter.com/devinschumacher" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">

          ...
          <div className="container relative py-10 md:py-32">
            <div className="mx-auto max-w-4xl text-center">
              ...
              <div className="mt-12 flex flex-wrap items-center justify-center gap-6">
                ...
                <Link href="https://serp.ly/@devinschumacher/instagram" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                  <Instagram className="h-6 w-6" />
                </Link>
                <Link href="https://serp.ly/@devinschumacher/linkedin" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <Link href="https://serp.ly/@devinschumacher/tiktok" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
        ...
        <section className="border-t container py-20 md:py-28" id="contact">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-8 text-sm text-muted-foreground">
              ...
              <Link href="https://serp.ly/@devinschumacher/linkedin" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-primary transition-colors">
